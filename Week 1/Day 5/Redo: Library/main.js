...
class UI{
    ...
    loadBooksFromLocalStorage(){
        ...
        const booksArr = JSON.parse(json);
        this.books = booksArr.map((x)=> Book.fromJSON(x))
    }
